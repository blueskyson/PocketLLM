...
export default function ChatInterface() {
  ...
  useEffect(() => {
    ...
    // Skip fetching if we just did an optimistic update to prevent flickering
      ...
      <div className="flex-1 flex flex-col w-full bg-gray-50">
        <div className="p-4 border-b border-gray-200 bg-white flex items-center justify-between">
           ...
           <button
             ...
             className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 rounded-md shadow-sm transition"
             title="Sign Out"
           >
